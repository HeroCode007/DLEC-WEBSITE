...
export const CLIENT_PARTNERS: ClientPartner[] = [
  ...
  { name: 'PepsiCo International', category: 'Food & Beverage', tag: 'Beverage & Snacks', subtext: 'Global Food Giant' },
  { name: 'Coca-Cola', category: 'Food & Beverage', tag: 'Beverage & Bottling', subtext: 'Global Beverage Leader' },
  { name: 'GlaxoSmithKline (GSK)', category: 'Pharmaceuticals & Health', tag: 'Pharma & Life Sciences', subtext: 'Global Healthcare' },
  { name: 'Atlas Honda', category: 'Automotive & Energy', tag: 'Automotive Manufacturing', subtext: 'Motorcycle & Power Products' },
  { name: 'Descon Engineering', category: 'Heavy Industry & Steel', tag: 'Heavy Engineering', subtext: 'EPCC Industrial Partner' },
  { name: 'FWO (Frontier Works Org)', category: 'Logistics & Infrastructure', tag: 'Defense & Infrastructure', subtext: 'Mega Civil Projects' },
  { name: 'Millat Tractors (MTL)', category: 'Automotive & Energy', tag: 'Agricultural Machinery', subtext: 'Massey Ferguson Manufacturer' },
  { name: 'Al-Ghazi Tractors', category: 'Automotive & Energy', tag: 'Farm Machinery', subtext: 'CNH Industrial Partner' },
  { name: 'PEL (Pak Elektron Limited)', category: 'Automotive & Energy', tag: 'Electrical & Appliances', subtext: 'Transformers & Electronics' },
  { name: 'NESPAK', category: 'Logistics & Infrastructure', tag: 'Engineering Consultancy', subtext: 'National Engineering Services' },
  { name: 'Haleeb Foods', category: 'Food & Beverage', tag: 'Dairy & Beverages', subtext: 'Pioneer Dairy Producer' },
  { name: 'Gourmet Foods', category: 'Food & Beverage', tag: 'FMCG & Bakery', subtext: 'Food Processing Leader' },
  { name: 'Simply Sufi', category: 'Food & Beverage', tag: 'Poultry & Food Products', subtext: 'Premium Meat Processing' },
  { name: 'Shezan International', category: 'Food & Beverage', tag: 'Juices & Food Processing', subtext: 'FMCG Pioneer' },
  { name: 'CCL Pharmaceuticals', category: 'Pharmaceuticals & Health', tag: 'Pharma Manufacturing', subtext: 'Healthcare Solutions' },
  { name: 'Saffron Pharmaceuticals', category: 'Pharmaceuticals & Health', tag: 'Medical Formulation', subtext: 'Quality Therapeutics' },
  { name: 'ICI Paints / AkzoNobel', category: 'Pharmaceuticals & Health', tag: 'Chemicals & Coatings', subtext: 'Performance Coatings' },
  { name: 'Brighto Paints', category: 'Pharmaceuticals & Health', tag: 'Paints & Finishes', subtext: 'Inspired by Nature' },
  { name: 'Sapphire Textiles', category: 'Textiles & Packaging', tag: 'Textile & Apparel', subtext: 'Premier Textile Group' },
  { name: 'Kohinoor Mills', category: 'Textiles & Packaging', tag: 'Spinning & Weaving', subtext: 'Export Textile Manufacturer' },
  { name: 'US Denim', category: 'Textiles & Packaging', tag: 'Denim Manufacturing', subtext: 'Sustainable Apparel' },
  { name: 'Urbansole', category: 'Textiles & Packaging', tag: 'Footwear & Retail', subtext: 'Fashion & Footwear' },
  { name: 'Treet Corporation', category: 'Textiles & Packaging', tag: 'Personal Care & Packaging', subtext: 'Diversified Conglomerate' },
  { name: 'Roshan Packages', category: 'Textiles & Packaging', tag: 'Corrugated Packaging', subtext: 'Flexible Packaging' },
  { name: 'Tri-Pack Films Limited', category: 'Textiles & Packaging', tag: 'BOPP & CPP Films', subtext: 'Packaging Films Leader' },
  { name: 'Packaging Solutions', category: 'Textiles & Packaging', tag: 'Industrial Packaging', subtext: 'Custom Container Tech' },
  { name: 'IPAK (Packages Group)', category: 'Textiles & Packaging', tag: 'Flexible Packaging', subtext: 'International Packaging' },
  { name: 'EMCO Industries', category: 'Automotive & Energy', tag: 'High Voltage Insulators', subtext: 'Power Grid Components' },
  { name: 'AFCO Steel', category: 'Heavy Industry & Steel', tag: 'Structural Steel', subtext: 'Construction Steel' },
];
